...
void ClosedLoopPlugin::Load(physics::ModelPtr _parent, sdf::ElementPtr _sdf)
{
  ...
  ignition::math::Pose3d joint_origin = ignition::math::Pose3d(
      positions_splited_converted[0], positions_splited_converted[1], positions_splited_converted[2],
      rotations_splited_converted[0], rotations_splited_converted[1], rotations_splited_converted[2]);
